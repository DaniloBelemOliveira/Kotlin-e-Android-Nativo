...
abstract class DAO <TModel,TEntity> (protected open val manager: EntityManager,
    ...
    open fun recureperarPeloId(id: Int):TModel{
        val query = manager.createQuery("FROM JogoEntity where id=:id",entityType)
